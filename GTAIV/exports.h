...
extern "C" int _sys_vsprintf(char* buffer, const char* format, char* va_list);
#define vsprintf _sys_vsprintf 

extern "C" char* _sys_strchr(char* str, int ch);
#define strchr _sys_strchr

extern "C" int _sys_isprint(int ch);
#define isprint _sys_isprint

extern "C" int _sys_isprint_ascii(int ch);
#define isprint_ascii _sys_isprint_ascii 

extern "C" size_t _sys_strcspn(const char* s1, const char* s2);
#define strcspn _sys_strcspn 
...
extern "C" void* _sys_memchr(void* str1, int ch, size_t n);
